...
__global__ void multihead_attention_fp16_kernel(scalar_t* Q,
                                                scalar_t* K,
                                                scalar_t* V,
                                                scalar_t* O,
                                                int       batch_size,
...
at::Tensor cuda_multipass_fmha_fp16(const at::Tensor& Q, const at::Tensor& K, const at::Tensor& V)
{
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(Q.scalar_type(),
                                        ...
                                        (
                                            [&]
                                            {
                                                multihead_attention_fp16_kernel<scalar_t>
